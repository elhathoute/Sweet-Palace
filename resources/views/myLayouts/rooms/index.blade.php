...
<div class="container-fluid">
    ...
    <div class="card shadow my-5">
        <div class="card-header py-3 d-flex align-items-center justify-content-between">
            <h6 class="m-0 fw-bold">Rooms</h6>
            <a href="{{url('myLayouts/rooms/create')}}" class="text-decoration-none btn btn-success">Add New Room</a>
        </div>
        <div class="card-body">
                        ...
                        @foreach ($rooms as $r)
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    ...
                                    <form action="{{ url('myLayouts/rooms'. '/'.$r->id)}}" method="POST">
                                        @csrf
                                        @method("DELETE")
